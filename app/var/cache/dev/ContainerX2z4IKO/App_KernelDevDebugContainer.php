...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\PublishDateEntitySubscriber'] ?? ($this->privates['App\\EventSubscriber\\PublishDateEntitySubscriber'] = new \App\EventSubscriber\PublishDateEntitySubscriber()));
        }, 1 => 'setDatePublished'], 33);
        $instance->addListener('kernel.response', [0 => function () {
