...
class BlogPost extends \App\Entity\BlogPost implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'id', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'title', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'published', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'content', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'author', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'slug', '' . "\0" . 'App\\Entity\\BlogPost' . "\0" . 'comments'];
        }
     ...
     * {@inheritDoc}
     */
    public function setTitle(string $title): \App\Entity\BlogPost
    {
     ...
     * {@inheritDoc}
     */
    public function setContent(string $content): \App\Entity\BlogPost
    {
