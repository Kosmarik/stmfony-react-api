...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\AuthoredEntitySubscriber'] ?? $this->load('getAuthoredEntitySubscriberService'));
        }, 1 => 'getAuthenticatedUser'], 33);
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->privates['App\\EventSubscriber\\PasswordHashSubscriber'] ?? $this->load('getPasswordHashSubscriberService'));
        }, 1 => 'hashPassword'], 33);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    protected function getSerializerService()
    {
        ...
        $e = ($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService());
        ...
        $g = ($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService());
        ...
        $k = new \ApiPlatform\Core\Swagger\Serializer\ApiGatewayNormalizer(new \ApiPlatform\Core\Swagger\Serializer\DocumentationNormalizer($e, $f, $g, ($this->privates['api_platform.hydra.json_schema.schema_factory'] ?? $this->getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()), ($this->privates['api_platform.json_schema.type_factory'] ?? $this->getApiPlatform_JsonSchema_TypeFactoryService()), new \ApiPlatform\Core\Bridge\Symfony\Routing\RouterOperationPathResolver($h, ($this->privates['api_platform.operation_path_resolver.custom'] ?? $this->getApiPlatform_OperationPathResolver_CustomService()), $i), NULL, $j, NULL, false, 'oauth2', 'application', '/oauth/v2/token', '/oauth/v2/auth', [], [], $i, true, 'page', false, 'itemsPerPage', $this->parameters['api_platform.formats'], false, 'pagination', [], $this->parameters['api_platform.swagger.versions']));
        ...
        $p = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($b, $l, $a, $c, $d, NULL, []);

        return $this->services['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($a), 1 => new \Symfony\Component\Serializer\Normalizer\GetSetMethodNormalizer($b, NULL, $c, $d), 2 => $k, 3 => new \ApiPlatform\Core\Hydra\Serializer\ConstraintViolationListNormalizer($h, [], $l), 4 => new \ApiPlatform\Core\Problem\Serializer\ConstraintViolationListNormalizer([], $l), 5 => $k, 6 => new \ApiPlatform\Core\Hydra\Serializer\DocumentationNormalizer($e, $f, $g, $m, NULL, $h, $i, $l), 7 => new \ApiPlatform\Core\Hydra\Serializer\EntrypointNormalizer($e, $n, $h), 8 => new \ApiPlatform\Core\Hydra\Serializer\ErrorNormalizer($h, true), 9 => new \ApiPlatform\Core\Problem\Serializer\ErrorNormalizer(true), 10 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 11 => new \ApiPlatform\Core\JsonLd\Serializer\ItemNormalizer($e, $f, $g, $n, $m, $o, $a, $l, $b, [], new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), false), 12 => new \ApiPlatform\Core\Serializer\ItemNormalizer($f, $g, $n, $m, $a, $l, $b, ($this->privates['debug.api_platform.item_data_provider'] ?? $this->getDebug_ApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            return new \EmptyIterator();
        }, 0), $e, false), 13 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(), 14 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 15 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $l), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 18 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(NULL), 19 => new \ApiPlatform\Core\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Core\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Core\Hydra\Serializer\CollectionNormalizer($o, $m, $n), 'page', 'pagination', $e, $a), $e, $m, $j), 20 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 21 => new \ApiPlatform\Core\JsonLd\Serializer\ObjectNormalizer($p, $n, $o), 22 => $p], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => new \Symfony\Component\Serializer\Encoder\JsonEncoder(), 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Core\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('6H1KXeHzYf', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+Gx8CHMW+q', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('9OMVuEATSO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.route_name_resolver'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('gAvkOuBFaO', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['api_platform.cache.subresource_operation_factory'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('HuoY5Ya3EL', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('o5pW6jLqlA', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('MOQ7akd6AN', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['logger'] ?? ($this->privates['logger'] = new \Symfony\Component\HttpKernel\Log\Logger())));
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->privates['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            ...
            yield 1 => ($this->privates['security.authentication.provider.dao.api'] ?? $this->load('getSecurity_Authentication_Provider_Dao_ApiService'));
