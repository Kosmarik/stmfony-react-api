...
class __TwigTemplate_0c51c2094c149b3e8638a4b7a959a09c7ce9c85f93eb2c792e5adcb96bd9d53c extends Template
{
    private $source;
    private $macros = [];
...
{% else %}
    <a href=\"mailto:{{ field.value }}\">{{ field.formattedValue }}</a>
{% endif %}
", "@EasyAdmin/crud/field/email.html.twig", "/var/www/project/vendor/easycorp/easyadmin-bundle/src/Resources/views/crud/field/email.html.twig");
    }
}
